                        ...
                        <ul class="header-dropdown">
                            ...
                            <li class="onhover-dropdown mobile-account"> <i class="fa fa-user" aria-hidden="true"></i>
                                ...
                                <ul class="onhover-show-div">
                                    <li><a href="<?php echo base_url('front_end/auth/login')?>">Login</a></li>
                                    <li><a href="<?php echo base_url('front_end/auth/register')?>">register</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="<?php echo base_url('assets/front/images/mega-menu/fashion.jpg');?>"
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <li><a href="#">pages</a>
                                            <ul>
                                                ...
                                                <li><a href="<?php echo base_url('front_end/Collection');?>">collection</a></li>
                                        ...
                                        <li>
                                            <a href="#">blog</a>
                                            <ul>
                                                <li><a href="<?php echo base_url('front_end/Blog');?>">left sidebar</a></li>
                                                <li><a href="<?php echo base_url('front_end/Blog/right_sidebar');?>">right sidebar</a></li>
                                                <li><a href="<?php echo base_url('front_end/Blog/nosidebar');?>">no sidebar</a></li>
                                                <li><a href="<?php echo base_url('front_end/Blog');?>">blog details</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </nav>
                                    ...
                                    <ul>
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            ...
                                            <ul class="show-div shopping-cart">
                                                ...
                                                <li>
                                                    <div class="buttons"><a href="<?php echo base_url('front_end/Account/Cart');?>" class="view-cart">view
